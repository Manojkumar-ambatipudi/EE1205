...
\begin{lstlisting}
https://github.com/Manojkumar-ambatipudi/EE1205/blob/mainmain/Audio_Filter/codes/Manoj_Singing.wav
\end{lstlisting}
\item 
\label{Python code}
...
The audio file is analyzed using Librosa Library in Python3. 

It is a contour plot depicting the Intensity as a function of frequency and time of the signal. The darker region depicts no sound and the yellow region depicts high sound region.
\begin{figure}[H]
    \includegraphics[width=0.9\columnwidth]{figs/Before_audiofiltering.png }
    \caption{Spectrogram of the audio file before Filtering}
    \label{fig:before_filter_plot}
\end{figure}
\begin{figure}[H]
\includegraphics[width=0.9\columnwidth]{figs/After_audiofilter.png}
...
\begin{lstlisting}
https://github.com/Manojkumar-ambatipudi/EE1205/blob/mainmain/Audio_Filter/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Manojkumar-ambatipudi/EE1205/blob/mainmain/Audio_Filter/codes/2.2.py
\end{lstlisting}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\columnwidth]{figs/Plot_xn_yn.png}
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/5.4.py   
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/dhanushnayakh03/EE1205/tree/main/Audio_Filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/fft.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/fft_python.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/6.4_time.c
\end{lstlisting}
The below python code extracts the data from these text files and plots Time vs $n$ for comparison.
\begin{lstlisting}
https://github.com/Manojkumar-amabtipudi/EE1205/blob/mainAudio_Filter/codes/6.4_plot.py
\end{lstlisting}
\begin{figure}[H]
\centering
