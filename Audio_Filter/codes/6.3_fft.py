...
my_lib = ctypes.CDLL('libfft.so') 

# Define the return type and argument types for the FFT function
my_lib.myfft.restype = ctypes.POINTER(ctypes.c_double * 2)
my_lib.myfft.argtypes = [ctypes.c_int, ctypes.POINTER(ctypes.c_double * 2)]
...
result = my_lib.myfft(n, input_data_c)
